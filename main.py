...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/TGJokerX")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/TGJokerX"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/TGJokerX")],
    ]
)
